...
set rc [catch {
  ...
  set_property ip_output_repo {{E:/CSE Labs and Codes/Nanoprocessor/Nanoprocessor.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet {{E:/CSE Labs and Codes/Nanoprocessor/Nanoprocessor.runs/synth_1/Processor.dcp}}
